Vue.component('project', {
    ...
    <div class="projects__box projects__page-box">
        <div class="projects__box-img"><a target="_blank" :href=" project.link "><img :src="'img/projects/' + project.img +  '.png'" alt=""></a></div>
        <div class="projects__box-info">
            <div class="projects__box-title">{{project.title}}</div>
            <a target="_blank" :href=" project.link " class="projects__box-link">Дивитися</a>
        </div>
    </div>
`
})
